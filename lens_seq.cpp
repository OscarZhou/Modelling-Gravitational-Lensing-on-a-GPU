...
int main(int argc, char* argv[]) 
{
  ...
  //std::cout<< "the length of xlens = "<<sizeof(xlens)/sizeof(float)<<std::endl;
  //std::cout<< "xlens[0] = "<<xlens[0]<<std::endl;
  //std::cout<< "ylens[0] = "<<ylens[0]<<std::endl;
  //std::cout<< "eps[0] = "<<eps[0]<<std::endl;
